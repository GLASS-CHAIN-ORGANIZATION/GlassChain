...
func (*GuessGameAction) XXX_OneofWrappers() []interface{} {
	return []interface{}{
...
func (*UnimplementedGuessServer) GuessStart(ctx context.Context, req *GuessGameStart) (*types.UnsignTx, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GuessStart not implemented")
}
func (*UnimplementedGuessServer) GuessBet(ctx context.Context, req *GuessGameBet) (*types.UnsignTx, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GuessBet not implemented")
}
func (*UnimplementedGuessServer) GuessStopBet(ctx context.Context, req *GuessGameStopBet) (*types.UnsignTx, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GuessStopBet not implemented")
}
func (*UnimplementedGuessServer) GuessAbort(ctx context.Context, req *GuessGameAbort) (*types.UnsignTx, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GuessAbort not implemented")
}
func (*UnimplementedGuessServer) GuessPublish(ctx context.Context, req *GuessGamePublish) (*types.UnsignTx, error) {
