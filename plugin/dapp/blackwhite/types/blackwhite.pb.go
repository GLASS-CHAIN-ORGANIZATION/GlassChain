...
func (*BlackwhiteAction) XXX_OneofWrappers() []interface{} {
	return []interface{}{
...
func (*UnimplementedBlackwhiteServer) Create(ctx context.Context, req *BlackwhiteCreate) (*types.UnsignTx, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (*UnimplementedBlackwhiteServer) Show(ctx context.Context, req *BlackwhiteShow) (*types.UnsignTx, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Show not implemented")
}
func (*UnimplementedBlackwhiteServer) Play(ctx context.Context, req *BlackwhitePlay) (*types.UnsignTx, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Play not implemented")
}
func (*UnimplementedBlackwhiteServer) TimeoutDone(ctx context.Context, req *BlackwhiteTimeoutDone) (*types.UnsignTx, error) {
