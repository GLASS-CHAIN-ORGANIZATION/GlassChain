...
# $1 dockerAddr; $2 docker ebrelayer name; $2 relayer.toml   
...
#        $1   BridgeRegistry     ; $2        10; $3 relayer.toml   
...
# eth      $1:      $2:url  ，    http://localhost:7545,      https://ropsten-rpc.linkpool.io/
