...
func (*RetrieveAction) XXX_OneofWrappers() []interface{} {
	return []interface{}{
...
func (m *AssetSymbol) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AssetSymbol.Merge(m, src)
}
...
func (*RetrieveQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_ef7b02fb18d30b6d, []int{9}
}
...
func init() {
	proto.RegisterFile("retrieve.proto", fileDescriptor_ef7b02fb18d30b6d)
}
...
func (*UnimplementedRetrieveServer) Prepare(ctx context.Context, req *PrepareRetrieve) (*types.UnsignTx, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Prepare not implemented")
}
func (*UnimplementedRetrieveServer) Perform(ctx context.Context, req *PerformRetrieve) (*types.UnsignTx, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Perform not implemented")
}
func (*UnimplementedRetrieveServer) Backup(ctx context.Context, req *BackupRetrieve) (*types.UnsignTx, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Backup not implemented")
}
func (*UnimplementedRetrieveServer) Cancel(ctx context.Context, req *CancelRetrieve) (*types.UnsignTx, error) {
